...
<div name="seamstress" style="min-height:350px;">
<a name="seamstress"></a>
<h2>Seamstress</h2>
<img class="img-fluid float-left mr-3" alt="1930 Art Deco dress" style="max-height:320px" src="{{"gallery/ahj/1.jpg"| relative_url}}" />
<img class="img-fluid float-right ml-3" alt="silk lined woollen coat" style="max-height:320px" src="{{"gallery/wool_silk_coat/1.jpg"| relative_url}}" />
<p>
